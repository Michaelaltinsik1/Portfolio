    ...
    >
      ...
      <ul className="flex flex-col mt-[32px] desktop:flex-row desktop:mt-0 ">
        <li>
          <Link
            onClick={() => setIsNavOpen(false)}
            className="nav-link text-primary-invert text-navItemMobile desktop:text-navItem px-4 py-[20px] desktop:px-[32px] flex hover:underline underline-offset-[6px] decoration-primary-invert"
            href="/#about"
          >
            About
          </Link>
